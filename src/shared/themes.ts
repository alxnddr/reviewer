// Runtime metadata for the curated theme set: ids, labels, appearance, the Pierre/Shiki diff theme
// name, and the pre-paint window background (chrome bg, hex for Electron). Hand-written, like its
// counterpart design/globals.css, which owns the colors themselves; themes.test.ts is what keeps the
// two honest, down to windowBackground equalling the block's --background.
